var canvas = new fabric.Canvas('pc');
...
$(document).ready(function() {
  $(".xc").change(function() {
    var p = $("#pc").css("background-color", $(".xc").val());
...
$(".txtt").click(function(){
  var comicSansText = new fabric.Textbox("WELCOME", {
...
$(".savee").click(function(){
  $("#pc").get(0).toBlob(function(blob){
    saveAs(blob,"My_IMGE.png");
